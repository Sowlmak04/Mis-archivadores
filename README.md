...
- Las zonas se muestran automáticamente en orden alfabético ascendente (A–Z), tanto en edición como en navegación.
...
v0.11.4 cierra la fase puramente local. La siguiente etapa prevista es migrar la persistencia y habilitar sincronización entre dispositivos mediante:
...
- **v0.11.1** — navegación superior más accesible, versión visible y documentación consolidada.
- **v0.11.2** — retirada completa de la reordenación manual y ordenación alfabética automática de zonas.
- **v0.11.3** — ubicaciones plegables en Editar zonas y acciones compactas mediante iconos de edición y eliminación.
- **v0.11.4** — ubicaciones ordenadas automáticamente de A a Z con comparación adaptada al español.
...
### Ajustes de interfaz de v0.11.4

En **Editar zonas**, las ubicaciones aparecen plegadas por defecto para facilitar la navegación cuando la estructura crece. Cada cabecera permite desplegar o plegar sus zonas sin modificar los datos. Las acciones Renombrar y Eliminar de ubicaciones y zonas se representan mediante iconos SVG compactos, conservando etiquetas accesibles y las mismas confirmaciones de borrado.


### Orden alfabético de ubicaciones

Las ubicaciones se presentan automáticamente de A a Z, con comparación adaptada al español. El orden se calcula a partir del nombre y no añade ninguna propiedad de orden al modelo de datos.

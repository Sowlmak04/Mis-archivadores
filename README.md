...
v0.11.3 cierra la fase puramente local. La siguiente etapa prevista es migrar la persistencia y habilitar sincronización entre dispositivos mediante:
...
### Ajustes de interfaz de v0.11.3

...
v0.11.2 cierra la fase puramente local. La siguiente etapa prevista es migrar la persistencia y habilitar sincronización entre dispositivos mediante:

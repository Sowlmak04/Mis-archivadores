...
const seedData = {
  ...
  zones: [
    ...
    { id: "salon-mueble-pelis-balda-0", locationId: "salon", name: "Balda 0", parentZoneId: "salon-mueble-pelis" },
    { id: "salon-mueble-pelis-balda-1", locationId: "salon", name: "Balda 1", parentZoneId: "salon-mueble-pelis" },
    { id: "salon-mueble-pelis-balda-2", locationId: "salon", name: "Balda 2", parentZoneId: "salon-mueble-pelis" },
    { id: "salon-mueble-pelis-balda-3", locationId: "salon", name: "Balda 3", parentZoneId: "salon-mueble-pelis" },
    ...
    { id: "luna-kallax-cajon-inferior", locationId: "habitacion-luna", name: "Cajón inferior", parentZoneId: "luna-kallax" },
    ...
    { id: "terraza-salon-sillon-izquierdo", locationId: "terraza-salon", name: "Sillón izquierdo", parentZoneId: null },
    { id: "terraza-salon-sillon-derecho", locationId: "terraza-salon", name: "Sillón derecho", parentZoneId: null },

    { id: "terraza-habita-armario-empotrado", locationId: "terraza-habita", name: "Armario empotrado", parentZoneId: null },
    { id: "terraza-habita-balda-0", locationId: "terraza-habita", name: "Balda 0", parentZoneId: "terraza-habita-armario-empotrado" },
    { id: "terraza-habita-balda-1", locationId: "terraza-habita", name: "Balda 1", parentZoneId: "terraza-habita-armario-empotrado" },
    { id: "terraza-habita-balda-2", locationId: "terraza-habita", name: "Balda 2", parentZoneId: "terraza-habita-armario-empotrado" },
    { id: "terraza-habita-balda-3", locationId: "terraza-habita", name: "Balda 3", parentZoneId: "terraza-habita-armario-empotrado" },
...
function zoneView(zoneId) {
  ...
  app.innerHTML = `
    ...
    <section class="list">
      ${containers.length ? containers.map(containerRow).join("") : `<div class="empty"><strong>Sin contenedores</strong>No hay elementos registrados todavía.</div>`}
    </section>
  `;

const STORAGE_KEY = "misArchivadores.data.v1";

const seedData = {
  locations: [
    { id: "salon", name: "Salón", icon: "⌂", description: "Armarios y Kallax" },
    { id: "oficina", name: "Oficina", icon: "▣", description: "Archivadores y cajones" },
    { id: "dormitorio", name: "Dormitorio", icon: "□", description: "Almacenaje personal" },
    { id: "trastero", name: "Trastero", icon: "◇", description: "Cajas y archivo" }
  ],
  zones: [
    { id: "armario-salon", locationId: "salon", name: "Armario salón" },
    { id: "kallax-salon", locationId: "salon", name: "Kallax" },
    { id: "mesa-oficina", locationId: "oficina", name: "Mesa y cajones" },
    { id: "archivo-oficina", locationId: "oficina", name: "Zona de archivo" }
  ],
  containers: [
    {
      id: "A01",
      locationId: "oficina",
      zoneId: "archivo-oficina",
      name: "Vivienda",
      type: "Archivador",
      note: "Documentación principal de la vivienda.",
      items: [
    ...
    },
    {
      ...
      name: "Electrónica",
      type: "Caja Kallax",
      note: "Cables, adaptadores y accesorios.",
      items: [
        "Cables HDMI",
        "Adaptadores USB",
        "Cargadores antiguos",
    ...
    },
    {
      ...
      name: "Papelería",
      type: "Cajón",
      note: "Material de uso frecuente.",
      items: [
        "Etiquetas adhesivas",
        "Grapas y clips",
...
function homeView() {
  ...
  app.innerHTML = `
      ...
      ${data.locations.map(loc => {
        ...
        return `
          <button class="card" data-location="${loc.id}">
            ...
            <p>${escapeHTML(loc.description)} · ${count} cont.</p>
          </button>
        `;
      }).join("")}
    </section>
    ...
    <div class="section-title">
      <h2>Acceso rápido</h2>
      <span>Últimos ejemplos</span>
    </div>

    <section class="list">
      ${data.containers.slice(0, 3).map(containerRow).join("")}
    </section>
  `;
